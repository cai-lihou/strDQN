...
from src.common.result_io import (
    append_excel_locked,
    attach_run_metadata,
    default_result_dir,
    delta_metadata,
...
try:
    ...
    print("Warning: Custom modules not found. Code requires src.diffusion.strict_tw_ic and src.models files.")
...
with contextlib.redirect_stdout(io.StringIO()):
    from scripts import train_strdqn as main_components
